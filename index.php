        ...
        <div class="container-fluid">
            <div class="row">
                ...
                ?>
                        ...
                        <!-------------------------------------------------- start group  ------------------------------------->
                        <div class="testimonial" id="group">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="border_testi">
                                            ...
                                            <div class="row d_flex">
                                                <div class="col-md-10 offset-md-1">
                                                    <div id="testimo" class="carousel slide our_testimonial"
                                                        data-ride="carousel">
                                                        <ol class="carousel-indicators">
                                                            <li data-target="#testimo" data-slide-to="0" class="active">
                                                            </li>
                                                            <li data-target="#testimo" data-slide-to="1"></li>
                                                            <li data-target="#testimo" data-slide-to="2"></li>
                                                            <li data-target="#testimo" data-slide-to="3"></li>
                                                        </ol>
                                                        <div class="carousel-inner">
                                                            <div class="carousel-item active">
                                                                <div class="container">
                                                                    <div class="carousel-caption posi_in">
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                <div
                                                                                    class="testomoniam_text text_align_center">
                                                                                    <i><img src="images/soubhik.jpg"
                                                                                            alt="#" /></i>
                                                                                    <h3>Soubhik Acharya</h3>
                                                                                    <span>Team Member</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-9">
                                                                                <div
                                                                                    class="testomoniam_text text_align_left">
                                                                                    <p>Hello everyone, my name is Soubhik Acharya and I am a web developer in this team. I have handled the frontend part mostly in this project ensuring its smooth operation. I have hands-on experience in Web Development (HTML, CSS, JavaScript, Bootstrap), C/C++ and Django. I am excited to be a part of this team and am looking forward to contributing my skills to help build and maintain the website.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="carousel-caption posi_in">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-9">
                                                                                <div
                                                                                    class="testomoniam_text text_align_left">
                                                                                    <p>Hello everyone, my name is PritiPaul and I am a web developer in this team. I have handled the Backend as well as Database part mostly in this project. I have hands-on experience in Web Development (HTML, CSS, Javascript, bootstrap,Flask, php & Mysql), C/C++.I  am excited to be a part of this team and am looking forward to working together to create a robust and efficient application.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="carousel-caption posi_in">
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                <div
                                                                                    class="testomoniam_text text_align_center">
                                                                                    <i><img src="images/bishal.jpg"
                                                                                            alt="#" /></i>
                                                                                    <h3>Bishal Kumar Ghosh</h3>
                                                                                    <span>Team Member</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-9">
                                                                                <div
                                                                                    class="testomoniam_text text_align_left">
                                                                                    <p>Myself Bishal Kumar Ghosh, from Techno International New Town. I have hands-on experience in Java, Python, Networks, Flutter, GCP and MongoDB.My main focus is to identify and fix bugs in this project and improve the overall performance of the application. I have done the documentation part mostly in this project. I am excited to be a part of this team and am looking forward to working together to deliver a high-quality product</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="carousel-caption posi_in">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-9">
                                                                                <div
                                                                                    class="testomoniam_text text_align_left">
                                                                                    <p>Myself Anirban Pal, from Techno International New Town. I have hands-on experience in Flutter, Firebase, and Blockchain Technology.My main focus is to ensure that our website and applications are hosted securely and efficiently, with minimal downtime and maximum performance. I am excited to be a part of this team and am looking forward to working together to deliver a reliable and user-friendly experience for our website visitors.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
